...
namespace Mane.BD
{
    public partial class WebModel<T> : WebModel where T : WebModel, new()
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static WebModelCollection All(int limit = 1000)
        ...
        /// </summary>
        /// <typeparam name="T">Tipo de modelo</typeparam>
        /// <returns>WebModel query</returns>
        public static WebModelQuery<T> Query()
        {
            return new WebModelQuery<T>();
        }
        /// <summary>
        ...
        public static WebModelCollection DataTableToModeloCollection(DataTable dt)
        {
            WebModelCollection mc = new WebModelCollection();
