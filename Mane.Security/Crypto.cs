...
namespace Mane.Security
{
    ...
    public class Crypto
    {
        ...
        /// <summary>
        /// Crea un hash seguro mediante Bcrypt a partir de cualquier cadena de texto, genera un hash de 60 caracteres
        /// </summary>
        /// <param name="text">Texto para generar el hash</param>
        /// <returns>Hash generado por Bcrypt,salt 11, SHA384</returns>
