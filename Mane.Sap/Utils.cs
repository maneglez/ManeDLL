...
namespace Mane.Sap.Helpers
{
    ...
    internal static class Utils
    {
        ...
        /// <summary>
        /// Convierte un enum a una lista de  objetos del tipo EnumObj
        /// </summary>
        /// <param name="tipo">tipo de enum</param>
        /// <returns>Lista EnumObj(Value,Name)</returns>
        ...
        /// </summary>
        /// <param name="cb">Combobox</param>
        public static void EnumToComboBox(DataGridViewComboBoxColumn cb, Type tipoEnum)
        {
            cb.DataSource = EnumToList(tipoEnum);
            cb.DisplayMember = "Name";
            cb.ValueMember = "Value";
